...
OBS 2: Dentro das pastas de código e testbench, há os arquivos "DigiLock" e "DigiLock_tb" respectivamente.
	Esses arquivos apresentam o projeto todo em conjunto com todas as partes unidas para a execução do projeto.
	Entretanto, o arquivo testbench dessse ("DigiLock_tb") não executou da forma correta, ou seja, não apresentou
	os resultados esperados infelizmente. Tentamos consertar, mas não foi possível.
...
OBS: Também funcionará para o projeto completo, a simulação também irá abrir e rodar, mas não apresentará os resultados
     corretos.
